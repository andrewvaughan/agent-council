...
Read the Product Council template from `canonical/councils/product-council.md` and evaluate the feature from all 6 member perspectives.
...
Read the Feature Council template from `canonical/councils/feature-council.md` and create the technical implementation plan.
...
Using the template from `canonical/templates/decision-record.md`, create a decision record that includes:
