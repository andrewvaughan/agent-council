...
> **Note**: This is a template showing how to document council decisions. Copy this format for real decisions.
...
See [002-api-pattern-trpc.md](./002-api-pattern-trpc.md) for a real architecture decision example.
